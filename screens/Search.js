    ...
    return(
      <View style={{borderWidth: 1}}>
        <ListItem key={i} bottomDivider>
          <Icon type={"antdesing"} name={"book"} size={40}></Icon>
          <ListItem.Content>
            ...
            <View style={styles.lowerLeftContainer}>
              <View style={styles.transactionContainer}>
                <Text style={[styles.transactionText, {
                  color: 
                  item.transaction_type === "issue"?"green":"red"
                }]}>
                  {item.transaction_type.charAt(0).toUpperCase()+item.transaction_type.slice()}
                </Text>
                <Icon type={"ionicon"} name={
                  item.transaction_type === "issue"? "checkmark-circle-outline"
                  : "arrow-redo-circle-outline"
                } color={item.transaction_type == "issue"?"green":"red"}></Icon>
              </View>
